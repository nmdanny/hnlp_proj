...
from os import pipe
from hnlp_proj.loader import load_ben_yehuda, load_debug, load_eng_test, load_ynet, YNET_STANZA_PICKLE  # noqa: F401, F403
...
df = load_ynet(with_pickle=True)
PICKLE_PATH = YNET_STANZA_PICKLE

if (PICKLE_PATH.exists()):
    raise ValueError(f"There is already a pickle file at {PICKLE_PATH}, please rename it to proceed")
